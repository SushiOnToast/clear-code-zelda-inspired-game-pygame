...
class UI:
    ...
    def show_bar(self, current_amount, max_amount, bg_rect, colour):
        ...
        pygame.draw.rect(self.display_surface, UI_BORDER_COLOUR, bg_rect, UI_BORDER_SIZE)
    ...
    def show_exp(self, exp):
        ...
        pygame.draw.rect(self.display_surface, UI_BORDER_COLOUR, text_rect.inflate(20, 20), UI_BORDER_SIZE)

    def selection_box(self, left, top, has_switched):
        bg_rect = pygame.Rect(left, top, ITEM_BOX_SIZE, ITEM_BOX_SIZE)
        pygame.draw.rect(self.display_surface, UI_BG_COLOUR, bg_rect)
        if has_switched:
            pygame.draw.rect(self.display_surface, UI_BORDER_COLOUR_ACTIVE, bg_rect, UI_BORDER_SIZE)
        else:
            pygame.draw.rect(self.display_surface, UI_BORDER_COLOUR, bg_rect, UI_BORDER_SIZE)
